    ...
    return (
        <div className='w-[85%]  h-screen    mx-auto '>
            ...
            <div className="cardandtotalamount flex w-full  min-h-[56%] mb-4">
                            ...
                            <div className="cartitem w-full shadow-md p-3 flex" key={cartitem.productid._id}>
                                <div className="image  flex gap-6 text-xl ">
                                    <img src={`${import.meta.env.VITE_API_URL}${cartitem.productid.imagePath}`}
                                        alt="" className='w-[35%] object-contain rounded-md' />
                ...
                <div className="second w-[30%]  flex justify-center ">

                    <div className="total w-[80%] shadow-md h-[40%] text-2xl flex flex-col gap-9 p-4 border-2 border-gray-100">
                     <h1>Total Amount:</h1>
                      <h2 className='self-end text-green-400'>$92000</h2>
                      <button className='bg-blue-500 p-1 rounded-lg text-white'>Proceed To Checkout</button>
                    </div>
